...
class data_helper(object):
    ...
    def student_find(self,query, collection, course=None, limit=10):
    ...
    def get_students_collection(self,StudentID=None, limit=100000000):
        def query():
    ...
    def get_subjects(self,batch_size=1000):
        ...
        cursor = self.db.subjects.find({}, {"_id": 1, "Description": 1, "Units": 1, "Teacher": 1})
    ...
    def get_semesters(self,batch_size=1000):
        ...
        cursor = self.db.semesters.find({}, {"_id": 1, "Semester": 1, "SchoolYear": 1})
    ...
    def get_curriculum(self,program_code):
        """
        Returns the curriculum for a given program code.
        """
        def query():

            program_doc = self.db.curriculum.find_one({"programCode": program_code})
