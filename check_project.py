...
# --- Folders to skip ---
SKIP_DIRS = {"venv", ".venv", "__pycache__", ".git", ".mypy_cache", ".pytest_cache","myenv"}
...
for file in py_files:
    ...
    try:
        ...
        result = subprocess.run(
            ["flake8", "--ignore=E501,E303,E121,W503,E131,E101,E111,E201,E231,W191,E203,W293,W291,E302,F401,F541,W391,E241,E306,E225,E503,E261,E262,W292,E402,206,E122,E226,E401,E305,E202,E221,E251,E301", file],
            capture_output=True,
            text=True
        )
