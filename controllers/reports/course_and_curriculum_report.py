...
def report_page(db):
    ...
    if report == "-- Select Report --":
        ...
        with st.spinner("Loading grade trends data...",show_time=True):
        ...
        with st.spinner("Preparing load intensity data...",show_time=True):
        ...
        with st.spinner("Loading General Education and Major data...",show_time=True):
